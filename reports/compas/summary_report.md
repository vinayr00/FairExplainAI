...
|---|---|---|---|---|---|
| RandomForest_Baseline | 0.6355 | 0.5772 | 0.6694 | 1.3344 | 0.0349 |
| RandomForest_Extended | 0.6389 | 0.5840 | 0.6857 | 1.1144 | 0.0321 |
| logistic_regression_Tuned | 0.6923 | 0.6296 | 0.7340 | 0.5000 | 0.0030 |
| decision_tree_Tuned | 0.6753 | 0.5945 | 0.7159 | 0.5000 | 0.0062 |
| random_forest_Tuned | 0.6996 | 0.6402 | 0.7360 | 0.5000 | 0.0120 |
| xgboost_Tuned | 0.7061 | 0.6553 | 0.7391 | 0.5000 | 0.0046 |
| lightgbm_Tuned | 0.7101 | 0.6616 | 0.7387 | 0.5000 | 0.0030 |
| catboost_Tuned | 0.7004 | 0.6442 | 0.7421 | 0.5000 | 0.0019 |
| random_forest_Mitigated | 0.6721 | 0.5978 | 0.0000 | 1.0000 | 0.0500 |
| xgboost_Mitigated | 0.6729 | 0.6130 | 0.0000 | 1.0000 | 0.0500 |
| logistic_regression_Mitigated | 0.6794 | 0.6347 | 0.0000 | 1.0000 | 0.0500 |
...
| logistic_regression Mitigated (DP) | 0.4415 | 1.0000 | 1.0000 | 0.0000 |


## 4. Multi-Criteria Recommendation Engine
- **Recommended Model**: **decision_tree_Tuned**
- **Overall Utility Score**: 0.6378
- **Justification**: The model 'decision_tree_Tuned' is recommended as the optimal choice. It achieved a combined utility score of 0.6378 (Accuracy: 0.6753, Demographic Parity Difference: 0.4555, Equalized Odds Difference: 0.6291, Training Time: 0.5000s).
